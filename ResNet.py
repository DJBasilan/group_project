...
def train_model():
    ...
    model.fit(train_samples, train_labels, epochs=25, batch_size=32)  # Change the number of epochs here
    testing = model.evaluate(test_samples, test_labels)
    print("Loss = " + str(testing[0]))
    print("Test Accuracy = " + str(testing[1]))
# END TRAIN_MODEL()

# Uncomment the line below to build and train the model
# train_model()
